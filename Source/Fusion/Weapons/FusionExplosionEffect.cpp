...
#include "FusionExplosionEffect.h"


AFusionExplosionEffect::AFusionExplosionEffect(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void AFusionExplosionEffect::BeginPlay()
{
	Super::BeginPlay();
...
void AFusionExplosionEffect::Tick(float DeltaSeconds)
{
