...
#include "FusionGameViewportClient.generated.h"


class SFusionConfirmationDialog;
...
class SFusionLoadingScreen : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SFusionLoadingScreen) {}
	SLATE_END_ARGS()
...
class FUSION_API UFusionGameViewportClient : public UGameViewportClient
{
